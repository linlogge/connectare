...
pub fn connectare_codegen(settings: ConnectareGenSettings) -> anyhow::Result<()> {
    ...
    let writers = pbjson_build::Builder::new()
        ...
        .extern_path(".google.protobuf", "::connectare::pbjson_types")
    ...
    for file in files.take().into_iter() {
        ...
        let contents = contents.replace("pbjson::", "connectare::pbjson::");
        let contents = contents.replace("prost::", "connectare::prost::");
        let contents = contents.replace("serde::", "connectare::serde::");
